...
points. Like before, log the average winner to the console. HINT: you will need
...
// Know the position of a value. If -1 the value doesn't exist in the array.
...
if (john.bmi > mark.bmi) {
  console.log(john.firstName + ' ' + john.lastName + ' BMI\'s is bigger.');
} else if (john.bmi < mark.bmi) {
  console.log(mark.firstName + ' ' + mark.lastName + ' BMI\'s is bigger.');
} else {
...
var john = {
  ...
  calcAccount: function () {
    ...
    for (var i = 0; i < this.bills.length; i++) {
      ...
      this.tips[i] = tip;
      this.fullAccounts[i] = tip + currentBill;
    }
  }
};
...
if (john.average > mark.average) {
  console.log('John paid highest tips in average.');
} else if(mark.average > john.average) {
  console.log('Mark paid highest tips in average.');
}
*/
